...
public class RecyclerView extends AppCompatActivity {
    ...
    private androidx.recyclerview.widget.RecyclerView contactRecView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactRecViewAdapter.setContact(contacts);

        contactRecView.setAdapter(contactRecViewAdapter);
